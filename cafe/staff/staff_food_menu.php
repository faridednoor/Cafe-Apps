...
<form enctype="multipart/form-data">  
  ...
  <tr>
    <tr>     
        ...
        <button><a href="staff_add_food.php">Add New Food</a></button></td>
      </tr>
        <th>Image</th>
        <th>Food Name</th>
        <th>Price</th>
...
$food_image = $row['food_image'];
    ...
    echo "
<tr>
    <td><img src='images/$food_image' width='150px' height='80px'></td>
    <td> $food_name </td>
    <td>RM $food_price</td>
    <td><a href='update_food_image.php?food_id=$food_id'>Update</a></td>
    <td><a href='staff_update_food.php?food_id=$food_id'>Update</a></td>
    <td><a href='staff_delete_food.php?food_id=$food_id'>Delete</a></td>
</tr>
   ";
  }
